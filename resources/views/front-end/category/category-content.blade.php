...
@section('body')
    ...
    <div class="content">
        <div class="products-agileinfo">
            ...
            <h2 class="tittle">{{ $category1->categoryName }}</h2>
            @endforeach
            <div class="container">
                            ...
                            <ul id="myTab" class="nav1 nav1-tabs left-tab" role="tablist">
                                ...
                                <div id="myTabContent" class="tab-content">
                                                    ...
                                                    <div  class="grid-arrival">
                                                        <figure>
                                                            <a href="{{ route('product-details',['id'=>$categoryProduct->id]) }}" class="new-gri">
                                                                <div class="grid-img">
                                                                    <img  src="{{asset($categoryProduct->product_image)}}" height="300px;" alt="">
                                                                </div>
                                                                <div class="grid-img">
                                                                    <img  src="{{asset($categoryProduct->product_image)}}" height="300px;"  alt="">
                                                                </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                                        @foreach($categoryProduct1 as $categoryProduct1)
                                        <div class="product-tab1">
                                            <div class="col-md-4 product-tab1-grid">
                                                <div class="grid-arr">
                                                    <div  class="grid-arrival">
                                                        <figure>
                                                            <a href="{{ route('product-details',['id'=>$categoryProduct1->id]) }}" class="new-gri">
                                                                <div class="grid-img">
                                                                    <img  src="{{asset($categoryProduct1->product_image)}}" height="300px;" alt="">
                                                                </div>
                                                                <div class="grid-img">
                                                                    <img  src="{{asset($categoryProduct1->product_image)}}" height="300px;"  alt="">
                                                                </div>
                                            ...
                                            <div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
                                                ...
                                                <div class="women">
                                                    <h6><a href="{{ route('product-details',['id'=>$categoryProduct1->id]) }}">{{$categoryProduct1->product_name}}</a></h6>
                                                    <span class="size">XL / XXL / S </span>
                                                    <p>{{$categoryProduct1->short_diccription}} </p>
                                                    <p ><em class="item_price">TK. {{$categoryProduct1->product_price}}</em></p>
                                                    <a href="#" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
